...
export const SITE = {
  ...
  url: "https://0xkagecrypt.github.io",
  title: "kagecrypt",
  /**
   ...
   */
  titleMark: "",
  tagline: "Solana security research",
  description:
    "0xkagecrypt — security researcher focused on Solana and the broader Rust-based chain ecosystem. Writeups and tooling.",
...
export const AUTHOR = {
  name: "0xkagecrypt",
  url: "https://github.com/0xkagecrypt",
  /** One or two sentences. Shown on /about and in structured data. */
  bio: "Security researcher focused on Solana and the broader Rust-based chain ecosystem.",
} as const;
...
export const SOCIAL: SocialLink[] = [
  { label: "X", href: "https://x.com/_0xkagecrypt" },
  { label: "GitHub", href: "https://github.com/0xkagecrypt" },
];
